...
export default function RegisterPage() {
  ...
  const generateKeys = useCallback(() => {
    ...
    const metaAddress = generateStealthMetaAddressFromKeys({
      spendingPublicKey: randomKeys.spendingPublicKey,
      viewingPublicKey: randomKeys.viewingPublicKey,
      schemeId: VALID_SCHEME_ID.SCHEME_ID_1,
    });
    ...
    setKeys({
      ...
      metaAddress: metaAddress as Hex,
    });
    setStep('preview');
  }, []);
        ...
        params: [
          {
            from: walletAddress,
            to: registryAddress,
            data: encodeRegisterKeys(keys.metaAddress),
          },
        ],
      });
  ...
  return (
    <div className="relative min-h-screen">
      ...
      <main className="relative z-10 max-w-3xl mx-auto px-6 pt-32 pb-20">
              ...
              {i < steps.length - 1 && (
                <div
                  className={`
                    ...
                    ${i < currentStepIndex ? 'bg-white/30' : 'bg-white/[0.06]'}
                  `}
                />
              )}
            </div>
        ...
        {/* Error */}
        {error && (
          <div className="mb-8 p-4 rounded-xl border border-red-500/20 bg-red-500/[0.03]">
          ...
          <div className="p-8 md:p-12">
            {step === 'connect' && (
              <div className="text-center py-8">
                <div className="w-20 h-20 mx-auto mb-8 rounded-2xl flex items-center justify-center border border-white/10">
            ...
            {step === 'generate' && (
              <div className="text-center py-8">
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                  <ChromeButton onClick={generateKeys}>
                    <span className="flex items-center gap-2">
                      <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
                        <path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z" />
                      </svg>
                  ...
                  <ChromeButton variant="secondary" onClick={() => setStep('connect')}>
                    Back
                  </ChromeButton>
                </div>
              </div>
            ...
            {step === 'preview' && keys && (
              <div>
                ...
                <div className="space-y-6 mb-8">
                  ...
                  <div className="p-4 rounded-xl border border-amber-500/10 bg-amber-500/[0.02]">
                    <div className="flex items-start gap-3">
                      <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="rgba(255,180,0,0.6)" strokeWidth="1.5" className="mt-0.5 shrink-0">
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                  <ChromeButton onClick={() => setStep('register')}>
                    <span className="flex items-center gap-2">
                  ...
                  <ChromeButton variant="secondary" onClick={() => setStep('generate')}>
                    Regenerate
                  </ChromeButton>
                </div>
              </div>
            ...
            {step === 'register' && keys && (
              <div className="text-center py-8">
                <div
                  className="w-20 h-20 mx-auto mb-8 rounded-2xl flex items-center justify-center border border-white/10"
                  style={isRegistering ? { animation: 'pulse-glow 2s ease-in-out infinite' } : {}}
                >
                  {isRegistering ? (
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                  {!isRegistering && (
                    <ChromeButton onClick={registerOnChain}>
                      <span className="flex items-center gap-2">
                        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
                          <path d="M9 12l2 2 4-4" />
                          <rect x="3" y="3" width="18" height="18" rx="2" />
                  ...
                  {!isRegistering && (
                    <ChromeButton variant="secondary" onClick={() => setStep('preview')}>
                      Back
                    </ChromeButton>
                  )}
                </div>
            ...
            {step === 'success' && (
              <div className="text-center py-8">
                ...
                {keys && (
                  <div className="mb-8">
                    <KeyDisplay
                      label="Your Public Stealth Address"
                      value={keys.metaAddress}
                      truncated={false}
                    />
                  </div>
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                  ...
                  <ChromeButton variant="secondary" onClick={() => {
                    if (keys) {
